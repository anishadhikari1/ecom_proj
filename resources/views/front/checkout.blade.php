                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           {!! Form::open(['url' => ['cart/update',$cartItem->rowId], 'method'=>'put']) !!}
                            ...
                            <td class="cart_total">
                                <p class="cart_total_price">रू{{$cartItem->subtotal}}</p>
                            </td>
                ...
                @csrf
                  ...
                  <h1>Shopper Information</h1>
                    ...
                    <hr>
                       ...
                       <span>
                       <input type="radio" name="pay" value="Cash on Delivery" checked="checked"> Cash on Delivery
                          </span>

                        <span>
                        <input type="radio" name="pay" value="paypal"> Esewa
          ...
          <div class="col-lg-4">
            <div class="block-body order-summary">
              ...
              <ul class="order-menu list-unstyled">
                <li class="d-flex justify-content-between"><span>Order Subtotal </span><strong>रू{{Cart::subtotal()}}</strong></li>
                <li class="d-flex justify-content-between"><span>Shipping and handling</span><strong>रू10.00</strong></li>
                <li class="d-flex justify-content-between"><span>Tax</span><strong>रू{{Cart::tax()}}</strong></li>
                <li class="d-flex justify-content-between"><span>Total</span><strong class="text-primary price-total">रू{{Cart::total()}}</strong></li>
              </ul>
            </div>
          </div>
        </div>
