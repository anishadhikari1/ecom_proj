            ...
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                        ...
                        <a href="{{url('/cart/addItem')}}/{{$p->pro_id}}" class="btn btn-success add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                    </div>
                ...
                <div class="product-image-wrapper">
                    <div class="single-products">
                        <div class="productinfo text-center">
                            ...
                            <h2>${{$p->pro_price}}</h2>
                            <p>  <a href="{{url('/product_details')}}/{{$p->pro_id}}">{{$p->pro_name}}</a></p>
                            <a href="{{url('/cart/addItem')}}/{{$p->pro_id}}" class="btn btn-success add-to-cart">
